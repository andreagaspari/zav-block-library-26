...
/**
 * Registra il blocco con le sue proprietà, l'editor e la funzione di salvataggio.
 */
    ...
    return <>
      <BlockControls>
        <ToolbarButton
          ...
          onClick={() => {
            props.setAttributes({fontWeight: (props.attributes.fontWeight == 'normal') ? "bold" : "normal"})
          }}
        />
        <ToolbarButton
          icon={
          ...
          onClick={() => {
            props.setAttributes({ isItalic: !props.attributes.isItalic })
          }}
        />
      </BlockControls>

      <span {...blockProps} >
        {(props.attributes.fontWeight == 'bold') ? <b>Hello World!</b> : <>Hello World!</>}
      </span>
    </>;
  },
  save: (props) => {
